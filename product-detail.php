    ...
    <div class="tab-content" id="tab-specs">
      <table class="specs-table">
        ...
        <tr>
          ...
          <td>Hợp kim nhôm 6061</td>
        </tr>
        <tr>
          <th>Hệ thống phanh</th>
          <td>Phanh đĩa cơ học</td>
        </tr>
        <tr>
          <th>Số cấp tốc độ</th>
          <td>7 cấp (Shimano)</td>
        ...
        <tr>
          <th>Chiều cao yên</th>
          <td>55 – 75 cm (điều chỉnh)</td>
        </tr>
        <tr>
          <th>Màu sắc có sẵn</th>
          <td>Cam, Xanh ngọc, Tím, Vàng, Hồng</td>
        </tr>
        <tr>
          <th>Xuất xứ</th>
          <td>Đài Loan</td>
    ...
    <div class="tab-content" id="tab-reviews">
      <div class="reviews-summary">
        ...
        <div class="reviews-bars">
          <div class="review-bar"><span>5 ⭐</span>
            <div class="bar">
              <div style="width:82%"></div>
            </div><span>82%</span>
          </div>
          <div class="review-bar"><span>4 ⭐</span>
            <div class="bar">
              <div style="width:12%"></div>
            </div><span>12%</span>
          </div>
          <div class="review-bar"><span>3 ⭐</span>
            <div class="bar">
              <div style="width:4%"></div>
            </div><span>4%</span>
          </div>
          <div class="review-bar"><span>2 ⭐</span>
            <div class="bar">
              <div style="width:1%"></div>
            </div><span>1%</span>
          </div>
          <div class="review-bar"><span>1 ⭐</span>
            <div class="bar">
              <div style="width:1%"></div>
            </div><span>1%</span>
          </div>
